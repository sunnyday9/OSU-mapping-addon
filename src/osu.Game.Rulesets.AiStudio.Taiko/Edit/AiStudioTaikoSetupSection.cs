...
/// <summary>
/// Setup page "AI Studio (Taiko)" section — audio path + generate entry.
/// </summary>
public partial class AiStudioTaikoSetupSection : Container
{
    ...
    public AiStudioTaikoSetupSection()
    {
    ...
    private void generate()
    {
        ...
        statusText.Text = "Generating (Taiko)...";

        Task.Run(() => new TaikoMapGenerator().GenerateAsync(settings))
